"""
topic_modeling_research.py

Performs topic modeling on research papers using BERTopic.
"""
...
OUTPUT_FILE = OUTPUT_DIR / "research_topic_results.json"


def run_topic_modeling_research():
    ...
    print(f"Generated topics for {len(results):,} research records")
